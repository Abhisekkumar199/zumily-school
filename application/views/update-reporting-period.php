...
$(document).ready(function(){  
    ...
    $(".check1").click(function(){     
        ...
        { 
            $('#errorMsg').html("<div class='alert alert-danger'>End date must be greater than start date.</div>");
        ...
        {
            $('#errorMsg').html("<div class='alert alert-danger'>Duplicates subjects are not allowed.</div>"); 
    		return false;
        }
...
<?php $subjects_marks = explode(";",$period_info['subjects_marks']); ?>
<input type="hidden" id="subject_count" name="subject_count" value="<?php echo count($subjects_marks); ?>" >
<span class="sizecharthtml" style="display:none;"> 
 ...
 <div class="tz-2 mainContant" style="background-color:#ffffff;">
    <div class="tz-2-com tz-2-main">
        ...
        <input type="hidden" name="reporting_period_id" id="reporting_period_id" value="<?php echo $reporting_period_id; ?>" />
        <div class="col-sm-12 "  style="margin-top:10px;min-height:400px; " > 
            ...
            <div class="row" style="padding-top:0px;background: #ffffff;">  
    			<div class="col-sm-3" > 
                    ...
                    <input type="text" class="form-control"  name="exam_name" id="exam_name" style="background-color:#ffffff;" value="<?php echo $period_info['exam_name']; ?>"   placeholder="Exam Name"   />      
                </div> 
    			<div class="col-sm-3" > 
                    <label class="change_title_start">Start Date</label>
                    <input type="text" class="form-control"  name="start_date" id="start_date" style="background-color:#ffffff;" value="<?php echo date("M d, Y",strtotime($period_info['start_date'])); ?>"    placeholder="Start Date"   />   
                    
                </div>   
                <div class="col-sm-3"  > 
                    <label class="change_title_end">End Date</label>
                    <input type="text" class="form-control"  name="end_date" id="end_date" style="background-color:#ffffff;"   value="<?php echo date("M d, Y",strtotime($period_info['end_date'])); ?>"   placeholder="Received Date"   />   
                   
                </div>  
            </div>  
            
            <div class=" row" style="margin-top:20px;margin-bottom:10px;background: #ffffff;"> 
                <div class="col-sm-3"  > 
                ...
                <div class="col-sm-3"  > 
                    <span class="input-group-text" id="EventbtnAdd"  ><i style="float: left;font-size: 25px;color:#151f31;margin-top:6px;margin-bottom:10px;" class="fa fa-plus-circle"></i></span>
                </div> 
            </div>
                ...
                <div class="col-sm-3"  > 
                    <select class="form-control subjects" name="subjects[]"     style="background-color:#ffffff;margin-bottom:5px;" required>
                        ...
                        <?php 
                	        ...
                	        {  
                	    ?>
                            <option value="<?php echo $subject->subject_id; ?>" <?php if($str[0]== $subject->subject_id) { ?> selected  <?php } ?> ><?php echo $subject->subject_name; ?></option>
                        <?php } ?>
                    </select>  
                </div> 
                <div class="col-sm-3"  > 
                    <input type="text" id="size" name="marks[]" value="<?php echo $str[1]; ?>" placeholder="Maximum Marks" style="background-color:#ffffff;margin-bottom:5px;" class="form-control" required>
                </div> 
                <div class="col-sm-3"  > 
                    <span class="input-group-text remove red " style="background: #4f92fe; color: #fff;margin-bottom:5px;"><i style="float: left;font-size: 25px;color:#151f31;margin-top: 6px;" class="fa fa-minus-circle"></i></span>
                </div> 
            </div> 
            <?php } ?>
