                ...
                <tbody> 
                    ...
                    <tr>
                        <td align="center" colspan="5" style="border-bottom: 1px solid #ddd; margin-top:10px;">
                           <strong><font color="red" style="font-size:20px; text-decoration: underline;" > Students List</font></strong>
                        </td> 
                    </tr> 
                    <tr>
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" width="10%">Name</th>
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" width="10%">Registration No.</th> 
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" width="10%">Date-of-birth</th> 
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" width="10%">Father Name</th> 
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" width="10%">Parent Mobile</th>  
                    </tr> 
	                <?php 
            	    ...
            	    ?>
                    <tr >
                        <td style="font-size:12px;"><?php echo $students->first_name." ".$students->middle_name." ".$students->last_name; ?></td>
                        <td style="font-size:12px;" ><?php echo $students->registration_no; ?></td> 
                        <td style="font-size:12px;" ><?php echo $students->date_of_birth; ?></td> 
                        <td style="font-size:12px;" ><?php echo $students->father_name;  ?> </td> 
                        <td style="font-size:12px;" ><?php echo $students->parent_mobile_no;  ?> </td> 
                    </tr> 
                    <?php } ?>  
