...
<div class="row">
    <div class="col-md-12" style="padding-right:0px;"><p style=" font-size:14px; ">Please enter 6-digit OTP code, sent on your registered phone.</p></div> 
</div> 
...
<div class="row">
    ...
    <input type="hidden" value="<?php echo @$school_otp; ?>" name="school_otp" id="school_otp" />
    </div>
    ...
    <div class="row"> 
        <div class="input-field  col s12">
            <input type="botton" class="btn btn-success form-control verifyForgetPasswordOTP" style="background-color:#1d2e63!important; border-color: #1d2e63!important;"  name="Submit" value="Verify">
        </div>    
    </div>   
