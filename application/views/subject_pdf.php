                ...
                <tbody> 
                    ...
                    <tr>
                        <td align="center" colspan="2" style="border-bottom: 1px solid #ddd; margin-top:10px;">
                           <strong><font color="red" style="font-size:20px; text-decoration: underline;" > Subjects List </font></strong>
                        </td> 
                    </tr> 
                    <tr>
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px">Subject Name</th>
            	    ...
            	    ?>
                    <tr >
                        <td style="font-size:12px;"><?php echo $subject->subject_name; ?></td>
                        <td style="font-size:12px;" ><?php echo $subject->description; ?></td> 
                    </tr> 
                    <?php } ?>  
