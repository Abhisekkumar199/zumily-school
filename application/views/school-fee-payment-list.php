...
<div class="tz-2-com tz-2-main">  
	<div class="row" style="background: #151f31;" >
	        <div class="col-md-8 col-xs-8" > 
			    <h4>Classes Register List for Students Fee Payment</h4>
		    </div>
            	...
            	<div class="table-responsive tab-inn ad-tab-inn" id="active">
                	<table class="table table-hover">
            	        ...
            	        <tr class=" "   >
                    		...
                    		<td class="text-right">   
                    		    <?php if($classregister->total_students > 0) { ?><a href="<?php echo base_url(); ?>class-register-students/<?php echo base64_encode($classregister->class_register_id); ?>" >Class Students</a>   <?php } else { ?>Class Students<?php }?> 
                    		</td>
                    	</tr>
