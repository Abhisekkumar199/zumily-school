                    	...
                    	<div class="table-responsive tab-inn ad-tab-inn" id="active">
                        	<table class="table table-hover">
                            	<thead>
                                	...
                                	<td  style="width: 150px;" ><span ><a href="javascript:void(0)"  >Paid Up-to </a></span></td>      
                                	<td style="width: 160px;" class="text-right">Action</td>
                            	</thead>
                            	<tbody> 
                            	    <?php 
                            	    ...
                            	    foreach($class_student_list as $student) { ?>
                            	     <tr class=" "   >
                                		...
                                		<td   class="text-right">  
                                		    <a href="<?php echo base_url(); ?>update-class-register-student-fee/<?php echo base64_encode($student->class_register_student_id)."-".base64_encode($class_register_id); ?>"   title="Upload Documents"  >Update Fee</a>
                                		    
                                		</td>  
                            		</tr>
                            	    <?php } } else { ?>
                            	    <tr><td colspan="6"><p style="color:red;text-align:center;"><strong>*** No record found ***</strong></p></td></tr>
                            	    <?php } ?>
                        	    </tbody>
                        	</table>
                    	</div>
