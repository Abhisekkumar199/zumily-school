...
<div class="tz-2-com tz-2-main">  
    <div class="row" style="background: #151f31;" >
        <div class="col-md-6 col-xs-6" > 
			<h4>Classe Registers for Fee Setup</h4>
		</div>
		<div class="col-md-6 col-xs-6" >
		    <form method="get" action="<?php echo base_url(); ?>class-register-fee" >
		    <div class="row"> 
            	...
            	<div class="table-responsive tab-inn ad-tab-inn" id="active">
                	<table class="table table-hover">
            	        ...
            	        <tr class=" "   >
                    		...
                    		<td class="text-right">   
                    		    <a href="<?php echo base_url(); ?>class-register-fee-details/<?php echo base64_encode($classregister->class_register_id); ?>" >Fee Setup</a> &nbsp;|&nbsp;
                    		    <a href="<?php echo base_url(); ?>class-register-additional-fee/<?php echo base64_encode($classregister->class_register_id); ?>" >Additional Fee</a>    
                    		</td>
                    	</tr>
