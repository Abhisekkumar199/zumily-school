...
<div class="tz-2 mainContant" style="background-color:#ffffff;" >
    <div class="tz-2-com tz-2-main">
        <h4  ><?php if(@$fee_info['students_additional_fee_id'] != '') { echo "Edit"; }else { echo "Add";} ?> Additional Fee
        ...
        <div class="hom-cre-acc-left hom-cre-acc-right">
            <div class="panel-body">
                <div class="hom-cre-acc-left hom-cre-acc-right">
                    <form id="formCheck" action="<?php echo base_url();?>/add-additional-fee-process" method="POST" enctype="multipart/form-data" id="subnewtopicform" style="background:#fff; border:1px solid #fff;"  autocomplete="off" onsubmit="return Validate(this);"> 
                        ...
                        <div class="col-md-12">
                            <div class="form-group"> 
                                <input type="text" class="form-control   test" id="amount"  name="amount" placeholder="Amount" value="<?php echo @$fee_type_info['total_fee'];  ?>" data-toggle="tooltip" data-placement="top" title="Amount" required="true" autocomplete="off" >
                            </div>
                            <div class="form-group"> 
