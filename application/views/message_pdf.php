                ...
                <tbody> 
                    ...
                    <tr>
                        <td align="center" colspan="4" style="border-bottom: 1px solid #ddd; margin-top:10px;">
                           <strong><font color="red" style="font-size:20px; text-decoration: underline;" > Messages List </font></strong>
                        </td> 
                    </tr> 
                    <tr>
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" >Title</th>
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" >Type</th>
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" >Sent to</th> 
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:0px" >Date-time-sent</th>  
                    </tr> 
	                <?php 
            	    ...
            	    ?>
                    <tr > 
                        <td style="font-size:12px;"><?php echo $messages->title; ?></td> 
                        <td style="font-size:12px;"><?php echo $messages->display_name; ?></td> 
                        <td style="font-size:12px;"><?php if($messages->sending_to == 'A'){ echo "All&nbsp;Students"; } else if($messages->sending_to == 'C') { echo "Selected&nbsp;Classes";  } else if($messages->sending_to == 'S') { echo "Selected&nbsp;Students";  }   ?></td> 
                        <td style="font-size:12px;"><?php echo $messages->message_date_created; ?></td>  
                    </tr> 
                    <?php } ?>  
                </tbody>
            </table> 
