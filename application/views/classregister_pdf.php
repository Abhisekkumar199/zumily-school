...
<html>
    <head>
        ...
        <title>Class Registers List</title>  
    </head> 
    <body>  
                ...
                <tbody> 
                    ...
                    <tr>
                        <td align="center" colspan="5" style="border-bottom: 1px solid #ddd; margin-top:10px;">
                           <strong><font color="red" style="font-size:20px; text-decoration: underline;" > Class Registers List</font></strong>
                        </td> 
                    </tr> 
                    <tr> 
                        ...
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:5px" width="10%">Room No.</th> 
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:5px" width="10%">Total Students </th> 
                        <th align="left" style="border-bottom: 1px solid #ddd;font-size:14px;padding:5px" width="30%">Class Teacher</th>  
                    </tr> 
	                <?php 
            	    ...
            	    ?>
                    <tr >
                        <td style="font-size:12px;"><?php echo $classregister->class_name_section; ?></td>
                        <td style="font-size:12px;"><?php echo $classregister->session_year; ?></td> 
                        <td style="font-size:12px;"><?php echo $classregister->room_no; ?></td> 
                        <td style="font-size:12px;"><?php echo $classregister->total_students;  ?> </td> 
                        <td style="font-size:12px;"><?php echo $classregister->first_name." ".$classregister->last_name;  ?> </td> 
                    </tr> 
                    <?php } ?>  
