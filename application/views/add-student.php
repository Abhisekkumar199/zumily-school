...
$(document).ready(function(){  
    ...
    $(".check1").click(function(){    
        ...
        data:{first_name:first_name,last_name:last_name,date_of_birth:selected_birth_date,father_name:father_name,student_id:student_id},  
        success:function(response){     
    	    ...
    	    { 
                ...
                $("#preloader").hide(); 
                $('#errorMsg').html("<div class='alert alert-danger'>Entered student info - First Name, Lastname, DOB, and Parent Name already exist. Please check the data.</div>"); 
                $('#first_name').css("border","1px solid red");  
    		    $('#first_name').focus();
    ...
    <div class="tz-2-com tz-2-main">
        ...
        <div class="hom-cre-acc-left hom-cre-acc-right">
            <div class="panel-body">
                <div class="hom-cre-acc-left hom-cre-acc-right">
                    <form id="formCheck"   name="student" action="<?php echo base_url();?>/add-student-process" method="POST" enctype="multipart/form-data"  style="background:#fff; border:1px solid #fff;"  onsubmit="return Validate(this);"> 
                        <?php
                        ...
                        <input type="hidden" name="profile_picture" id="profile_picture" value="<?php echo @$student_info['profile_picture']; ?>">
                        <div class="col-sm-12">
