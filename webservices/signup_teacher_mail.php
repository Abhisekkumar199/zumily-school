...
$messagec='<body style="width:100%; float:left; padding:0; margin:0; font-family:arial">
            ...
            <tr><td colspan="3"  valign="top" align="center"><h3 style="font-size:17px; margin-bottom:10px"><strong>COMMUNICATE WITH STUDENTS</strong></h3></td></tr>
            <tr>
            ...
            <tr>
            	...
            	Now, you are connected with your students to send messages, take attendance online, approve/deny leave request, etc.
            	</p>
            
            	<h3 style="padding:0 20px; margin-bottom:0"><strong>Benefits:</strong></h3>
            	<ul style="font-size:14px; line-height:20px; margin-top:0">
            		<li>You can send real-time notifications to your class students.</li>
            		<li>You can approve or deny leave request just in a single click.</li>
            		<li>It’s very easy to take online attendance for your class.</li>
            		<li>You can track student’s fee status online.</li>
