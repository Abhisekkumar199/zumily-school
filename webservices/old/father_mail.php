...
$fromf=$CompanyEmail;
$tof=$sqlUser['fatheremail'];
$fname=$sqlUser['fathername'];
$sendername= $sqlUser1['business_name'];
$subjectf="Email From $sendername";
$messagef='<body style="width:100%; float:left; padding:0; margin:0; font-family:arial">
