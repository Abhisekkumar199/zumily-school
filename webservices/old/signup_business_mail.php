...
$toc=$emailid;
$fname=$username;
$subjectc="New Account - E-Mail varification link";
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff">
  ...
  <tr>
	...
	<tr><td>&nbsp;</td></tr>
		...
		<tr><td colspan="3"  valign="top" align="center"><h3 style="font-size:17px; margin-bottom:10px"><strong>GROW YOUR BUSINESS</strong></h3></td></tr>
		<tr>
...
<tr>
			...
			Now, you can start listing your fliers, coupons, deals, or any kind of reminders and people in your neighborhood can see these on zumily.com or on the app if they have downloaded it.<br><br>

			Please remember to ask your customers to check your business on our website or app and <i>favorite</i> it.
			</p>
			...
			<ul style="font-size:14px; line-height:20px; margin-top:0">
				...
				<li>And, as a promotion, you can publish your Fliers, Coupons, and Deals absolutely FREE for the first 180 days after you create your account.</li> 
			</ul>
